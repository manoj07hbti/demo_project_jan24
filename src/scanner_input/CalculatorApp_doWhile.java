...
public class CalculatorApp_doWhile {
    ...
    public static void main(String[] args) {
        CalculatorApp_doWhile obj=new CalculatorApp_doWhile();
        String revert ="Y";
        do {
            int result = 0;
            ...
            //TODO we should have option to select which operation you want to perform and based on user choice out put should come
