...
public class Employee {
    ...
    public Employee(String name, int id, char gender, int Salary , int mobile) {
        this.name = name;
        this.id = id;
        this.Gender = gender;
        this.Salary= Salary;
...
class UserEmp{
    ...
    Employee employee1=new Employee("Arjun",420,'M',38903,1088686777);
    Employee employee2=new Employee("Akash",421,'M',25000,1089986787);
    Employee employee3=new Employee("Azad",422,'M',68000,1088967017);
    Employee employee4=new Employee("Ahmad",423,'M',53000,1088687647);
    Employee employee5=new Employee("Adnan",424,'M',30000,138886645);
    Employee employee6=new Employee("Akram",425,'M',40000,1874598994);
